...
namespace SolidFoundations.Framework.Utilities.Extensions
{
    public static class TextureExtension
    {
        public static Texture2D CreateSelectiveCopy(this Texture2D sourceTexture, GraphicsDevice device, Rectangle selectionRect)
        {
            ...
            {
                SolidFoundations.monitor.Log("Issue creating a selective texture copy, likely out of bounds for dimensions.", StardewModdingAPI.LogLevel.Trace);
            }
